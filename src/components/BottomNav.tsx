    ...
    <nav className="fixed bottom-0 w-full z-40 pb-safe bg-surface-container-lowest/95 backdrop-blur-xl border-t border-outline-variant/30 shadow-[0_-4px_16px_rgba(0,0,0,0.4)]">
      <div className="flex items-center justify-between h-20 px-gutter max-w-md mx-auto">
        ...
        <button
          ...
          className="relative -top-3 flex flex-col items-center justify-center w-16 h-16 rounded-full bg-primary-container text-on-primary-fixed border-2 border-primary-fixed-dim transition-transform active:translate-y-0.5 flex-shrink-0 cursor-pointer"
          style={{
            boxShadow: '0 0 24px var(--theme-primary-container)',
          }}
        >
